<template>
  <div class="page-login">
    <div class="page-login-form"  :style="{ zIndex: $store.state.status.isDrawerOpen ? '-1' : '0' }">
      ...
      <div class="page-login-form-middle">
        ...
        <el-button type="primary" class="login" :loading="loading"  @click="login('ruleForm')">登 录</el-button>
        <div class="register">
...
export default {
  ...
  methods:{
    // ...mapMutation({
    //   set_userInfo:user/SET_USERIONFO
    // }),
    login(formName) {
